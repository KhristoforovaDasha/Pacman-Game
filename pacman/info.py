...
GHOST_RED = pygame.transform.scale(pygame.image.load('ghost_red.png'), (30, 30))
GHOST_YELLOW = pygame.transform.scale(pygame.image.load('ghost_yellow.png'), (30, 30))
GHOST_BLUE = pygame.transform.scale(pygame.image.load('ghost_blue.png'), (30, 30))
DOT_COLOUR = YELLOW
WALL_COLOUR = RED
